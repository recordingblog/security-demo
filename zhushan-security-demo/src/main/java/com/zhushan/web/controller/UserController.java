package com.zhushan.web.controller;
...
import com.zhushan.dto.UserQueryCondition;
...
public class UserController {
	...
	@GetMapping("/me") // @AuthenticationPrincipal UserDetails user
	public Object getCurrentUser(Authentication user,HttpServletRequest request) throws Exception{
	/*	String header = request.getHeader("Authorization");
		if(header==null){
			System.out.println("-------header Authorization is null --------");
		}
		String token = org.apache.commons.lang3.StringUtils.substringAfter(header, "bearer");
